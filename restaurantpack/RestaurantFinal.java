/*
	Joseph Angelino's final project:
	Restaurant Program
*/

package restaurantpack;
import restaurantpack.*;
...
class RestaurantFinal {
  public static void main(String args[]) throws java.io.IOException {
    Lunch lunchArray[] = new Lunch[9];					//lunch array for lunch menu
    ...
    Dinner dinnerArray[] = new Dinner[10];				//dinner array for dinner menu
    ...
    Scanner myObj = new Scanner(System.in);  					// Create a Scanner object	
      String str;								//Program Start
      boolean done = false;
      boolean finish = false;							//declare and initialize necessary variables
      char choice = ' ';
      ...
      while (!done) {
        System.out.println("Are you dining after 4:00 pm? (Y/N)");		//determines dinner menu print vs lunch menu print
        str = myObj.nextLine();
	choice = str.charAt(0);

	//System.out.println("choice:\" " + choice + "\"");			//debugging
    ...
    System.out.println();											//begin bill calculation
